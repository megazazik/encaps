...
export declare function connect({rootController, path, stateToProps, dispatchToProps, mergeProps, noConvertToComponentProps}?: IConnectParams): (component: React.ComponentType<any>) => React.StatelessComponent<any>;
