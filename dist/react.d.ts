...
export declare function createContainer<S extends object, Actions, SubActions, P, StateProps, ActionsProps, ViewP>({controller, stateToProps, dispatchToProps, mergeProps}: IGetPropsParams<S, Actions, SubActions, P, StateProps, ActionsProps, ViewP>): {
